...
public class Marks {
    public static void main(String[] args) {
        ...
        System.out.println("                                                              ");
        System.out.println(
                "|Name:Festus Gitahi Kinyua         |Roll_No:C026-01-0913/2022            Semester:2.2                ");
        System.out.println(
                "---------------------------------------------------------------------------------------------------------------");
        System.out.println("|Unit_Code                    |Unit_Name                               |Score");
        System.out.println(
                " --------------------------------------------------------------------------------------------------------------");
        System.out.println("|" + databaseCode + "                      " + "|Database                                |"
                + databaseScore);
        System.out.println("|" + systemsCode + "                      " + "|System                                  |"
                + Systemsscore);
        System.out.println("|" + AlgorithimCode + "                     "
                + " |Algorithms                             |" + AlgorithimsScore);
        System.out.println("|" + statisticCode + "                      " + "|Statistic                               |"
                + Statisticsscore);
        System.out.println(
                "----------------------------------------------------------------------------------------------------------------");
